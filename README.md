...
You must install the exporter on the LiteSpeed machine where the information is to be exported from.  Prometheus can run on another machine, but this software must be install on the LiteSpeed machine to be monitored.
